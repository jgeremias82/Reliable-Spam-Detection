...
saida = 'predictionsRejeitadas/'
caminho = 'predictions/'

datasets = ['02-dos_conhecido.csv']
...
for dataset in datasets:
    for model in models:
        ...
        arquivoPredictions = pd.read_csv(caminho + str(dataset) + '_' + str(model) + '_pred.csv')
        ...
        arq_write = open(saida + str(dataset) + '_' + str(model) + '_ProbAcc.csv', 'w')
